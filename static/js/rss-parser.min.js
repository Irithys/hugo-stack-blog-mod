!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = e(require("xmlbuilder")))
    : "function" == typeof define && define.amd
    ? define(["xmlbuilder"], e)
    : "object" == typeof exports
    ? (exports.RSSParser = e(require("xmlbuilder")))
    : (t.RSSParser = e(t.xmlbuilder));
})(this, function (t) {
  return (function (t) {
    var e = {};
    function r(n) {
    ...
    function (t, e, r) {
      ...
      (function (t) {
        ...
        function I(t, e, r, n, o) {
          return o || q(t, 0, r, 4), i.write(t, e, r, n, 23, 4), r + 4;
        }
        function M(t, e, r, n, o) {
          return o || q(t, 0, r, 8), i.write(t, e, r, n, 52, 8), r + 8;
        }
    ...
    function (t, e, r) {
      ...
      function p() {
        h &&
          c &&
          ((h = !1), c.length ? (l = c.concat(l)) : (f = -1), l.length && d());
      }
      function d() {
        if (!h) {
          var t = u(p);
      ...
      (o.nextTick = function (t) {
        ...
        l.push(new g(t, e)), 1 !== l.length || h || u(d);
      }),
    ...
    function (t, e, r) {
      ...
      (function (e, n, i) {
        ...
        function b(t) {
          if (((a = a || r(2)), !(d.call(b, this) || this instanceof a)))
            return new b(t);
          ...
          if (t._writev && r && r.next) {
            ...
            for (; r; ) {
              var c = r.chunk,
                ...
                h = r.callback;
              if (
                (v(t, e, !1, e.objectMode ? 1 : c.length, c, l, h),
                (r = r.next),
              ...
              (!(function (t, e) {
                e.prefinished ||
                  ...
                  ("function" == typeof t._final
                    ? (e.pendingcb++, (e.finalCalled = !0), o.nextTick(_, t, e))
      ...
      (s.prototype.parse = function (t, e, r) {
        ...
        if (!y[E] && (S || (E && !b[E]))) {
          for (var A, x, R = -1, C = 0; C < p.length; C++) {
            -1 !== (N = w.indexOf(p[C])) && (-1 === R || N < R) && (R = N);
          }
          -1 !== (x = -1 === R ? w.lastIndexOf("@") : w.lastIndexOf("@", R)) &&
            ((A = w.slice(0, x)),
            (w = w.slice(x + 1)),
          ...
          for (C = 0; C < f.length; C++) {
            var N;
            -1 !== (N = w.indexOf(f[C])) && (-1 === R || N < R) && (R = N);
          }
          -1 === R && (R = w.length),
            (this.host = w.slice(0, R)),
            (w = w.slice(R)),
            this.parseHost(),
          ...
          if (!L)
            for (
              var O = this.hostname.split(/\./), k = ((C = 0), O.length);
              C < k;
              C++
            ) {
              var D = O[C];
              if (D && !D.match(d)) {
                for (var P = "", q = 0, I = D.length; q < I; q++)
                  D.charCodeAt(q) > 127 ? (P += "x") : (P += D[q]);
                if (!P.match(d)) {
                  var M = O.slice(0, C),
                    U = O.slice(C + 1),
                    B = D.match(g);
                  B && (M.push(B[1]), U.unshift(B[2])),
                    U.length && (w = "/" + U.join(".") + w),
        ...
        if (
          (-1 !== Y
            ? ((this.search = w.substr(Y)),
              (this.query = w.substr(Y + 1)),
              e && (this.query = v.parse(this.query)),
              (w = w.slice(0, Y)))
            : e && ((this.search = ""), (this.query = {})),
          w && (this.pathname = w),
          b[_] && this.hostname && !this.pathname && (this.pathname = "/"),
        ...
        (s.prototype.resolveObject = function (t) {
            ...
            if (S)
              (r.hostname = r.host = _.shift()),
                (N =
                  ...
                  ((r.auth = N.shift()), (r.host = r.hostname = N.shift()));
            return (
              (r.search = t.search),
              (r.query = t.query),
          ...
          var N,
            L = "" === _[0] || (_[0] && "/" === _[0].charAt(0));
          S &&
            ((r.hostname = r.host = L ? "" : _.length ? _.shift() : ""),
            (N = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) &&
              ((r.auth = N.shift()), (r.host = r.hostname = N.shift())));
          return (
            (T = T || (r.host && _.length)) && !L && _.unshift(""),
            _.length
              ? (r.pathname = _.join("/"))
      ...
      (function (e, n) {
        ...
        (v.prototype.read = function (t) {
          ...
          (v.prototype.pipe = function (t, e) {
            ...
            var u =
              (!e || !1 !== e.end) && t !== n.stdout && t !== n.stderr ? l : v;
            function c(e, n) {
              p("onunpipe"),
                e === r &&
                  n &&
          ...
          (v.prototype.on = function (t, e) {
            ...
            if ("data" === t)
              ...
              n.endEmitted ||
                ...
                (n.emittedReadable = !1),
                n.reading ? n.length && _(this) : i.nextTick(R, this));
            }
            return r;
          }),
        ...
        f = (function () {
          function t() {
            ...
            i(this, t),
              ...
              e.maxRedirects || (e.maxRedirects = 5),
              e.timeout || (e.timeout = 6e4),
              (this.options = e),
              (this.xmlParser = new a.Parser(this.options.xml2js));
          }
          return (
            n(t, [
              {
                    ...
                    n = new Promise(function (e, n) {
                      r.xmlParser.parseString(t, function (t, i) {
                        ...
                        if (i.feed) o = r.buildAtomFeed(i);
                          ...
                          i.rss.$ &&
                          i.rss.$.version &&
                          i.rss.$.version.match(/0\.9/)
                        )
                          o = r.buildRSS0_9(i);
                        else {
                          if (!i.rss || !r.options.defaultRSS)
                            return n(
                ...
                value: function (t, e) {
                  var r = this,
                    ...
                    d = new Promise(function (e, o) {
                      ...
                      a(s, function (s) {
                        if (
                          r.options.maxRedirects &&
                          s.statusCode >= 300 &&
                          s.statusCode < 400 &&
                          s.headers.location
                        ) {
                          if (n === r.options.maxRedirects)
                            return o(new Error("Too many redirects"));
                          var a = u.resolve(t, s.headers.location);
                          return r.parseURL(a, null, n + 1).then(e, o);
                        }
                        if (s.statusCode >= 300)
                          return o(new Error("Status code " + s.statusCode));
                        var c = l.getEncodingFromContentType(
                        ...
                        s.setEncoding(c),
                          ...
                          s.on("end", function () {
                            return r.parseString(i).then(e, o);
                          });
                      }).on("error", o),
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this,
                    r = { items: [] };
                  if (
                    (l.copyFromXML(t.feed, r, this.options.customFields.feed),
                    t.feed.link &&
                      ((r.link = l.getLink(t.feed.link, "alternate", 0)),
                      (r.feedUrl = l.getLink(t.feed.link, "self", 1))),
                    t.feed.title)
                  ) {
              ...
              },
              {
                ...
                value: function (t) {
                  var e = {};
                  if (
                    (l.copyFromXML(t, e, this.options.customFields.item),
                    t.title)
                  ) {
                    var r = t.title[0] || "";
                  ...
                  return (
                    t.link &&
                      t.link.length &&
                      (e.link = l.getLink(t.link, "alternate", 0)),
                    t.published &&
                      t.published.length &&
                      t.published[0].length &&
                      (e.pubDate = new Date(t.published[0]).toISOString()),
                    !e.pubDate &&
                      t.updated &&
                      t.updated.length &&
                      t.updated[0].length &&
                      (e.pubDate = new Date(t.updated[0]).toISOString()),
                    t.author &&
                      t.author.length &&
                      t.author[0].name &&
                      t.author[0].name.length &&
                      (e.author = t.author[0].name[0]),
                    t.content &&
                      t.content.length &&
                      ((e.content = l.getContent(t.content[0])),
                      (e.contentSnippet = l.getSnippet(e.content))),
                    t.summary &&
                      t.summary.length &&
                      (e.summary = l.getContent(t.summary[0])),
                    t.id && (e.id = t.id[0]),
                    this.setISODate(e),
                    e
                  );
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  var n = { items: [] },
                    ...
                    o = c.item.concat(this.options.customFields.item);
                  if (
                    (t["atom:link"] &&
                      t["atom:link"][0] &&
                      t["atom:link"][0].$ &&
                      (n.feedUrl = t["atom:link"][0].$.href),
                    t.image && t.image[0] && t.image[0].url)
                  ) {
                    n.image = {};
                    var s = t.image[0];
                    s.link && (n.image.link = s.link[0]),
                      s.url && (n.image.url = s.url[0]),
                      s.title && (n.image.title = s.title[0]),
                      s.width && (n.image.width = s.width[0]),
                      s.height && (n.image.height = s.height[0]);
                  }
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    l.copyFromXML(t, r, e),
                    t.enclosure && (r.enclosure = t.enclosure[0].$),
                    t.description &&
                      ((r.content = l.getContent(t.description[0])),
                      (r.contentSnippet = l.getSnippet(r.content))),
                    t.guid &&
                      ((r.guid = t.guid[0]), r.guid._ && (r.guid = r.guid._)),
                    t.category && (r.categories = t.category),
                    this.setISODate(r),
                    r
                  );
                },
                ...
                value: function (t, e) {
                  ...
                  if (((t.itunes = {}), e["itunes:owner"])) {
                    ...
                    e["itunes:owner"][0]["itunes:name"] &&
                      (n.name = e["itunes:owner"][0]["itunes:name"][0]),
                      e["itunes:owner"][0]["itunes:email"] &&
                        (n.email = e["itunes:owner"][0]["itunes:email"][0]),
                      (t.itunes.owner = n);
                  }
                  if (e["itunes:image"]) {
                    var i;
                    (i =
                      ...
                      e["itunes:image"][0].$.href
                        ? e["itunes:image"][0].$.href
                        : null) && (t.itunes.image = i);
                  }
                  if (e["itunes:category"]) {
                  ...
                  if (e["itunes:keywords"])
                    if (e["itunes:keywords"].length > 1)
                      t.itunes.keywords = e["itunes:keywords"].map(function (
                        t
                      ) {
                        return t.$.text;
                      });
                      ...
                      s && "string" == typeof s._ && (s = s._),
                        s && s.$ && s.$.text
                          ? (t.itunes.keywords = s.$.text.split(","))
                          : "string" == typeof s &&
                            (t.itunes.keywords = s.split(","));
                    }
                  l.copyFromXML(e, t.itunes, c.podcastFeed),
                    r.forEach(function (e, r) {
                      var n = t.items[r];
                      (n.itunes = {}),
                        l.copyFromXML(e, n.itunes, c.podcastItem);
        ...
        !(function (s) {
          ...
          function T(t, e) {
            ...
            return (
              ...
              n + w((t = t.replace(g, ".")).split("."), e).join(".")
            );
          }
          function E(t) {
          ...
          function x(t) {
            ...
            for (i = r > 0 ? r + 1 : 0; i < d; ) {
              for (
                ...
                s > y(f / (l = 36 - c)) && v("overflow"), (s *= l);
              (b = A(g - o, (e = p.length + 1), 0 == o)),
                y(g / e) > f - m && v("overflow"),
                (m += y(g / e)),
                (g %= e),
                p.splice(g++, 0, m);
            }
          ...
          function R(t) {
            var e,
              ...
              w = [];
            for (
              p = (t = E(t)).length, e = 128, r = 0, o = 72, s = 0;
              s < p;
              ++s
            )
              (h = t[s]) < 128 && w.push(b(h));
            for (n = i = w.length, i && w.push("-"); n < p; ) {
              for (a = f, s = 0; s < p; ++s)
                (h = t[s]) >= e && h < a && (a = h);
              for (
                a - e > y((f - r) / (d = n + 1)) && v("overflow"),
                  r += (a - e) * d,
                  e = a,
                  s = 0;
                s < p;
      ...
      (function () {
        ...
        (t = r(52)),
          ...
          (e.Builder = (function () {
            function e(t) {
              var e, r, n;
              for (e in ((this.options = {}), (r = i[0.2])))
                u.call(r, e) && ((n = r[e]), (this.options[e] = n));
                ...
                return (
                  ...
                  (c = function (t, e) {
                    ...
                    if ("object" !== (void 0 === e ? "undefined" : n(e)))
                      f.options.cdata && s(e) ? t.raw(a(e)) : t.txt(e);
                    else if (Array.isArray(e)) {
                      for (p in e)
                        if (u.call(e, p))
                          for (d in (l = e[p]))
                            (h = l[d]), (t = c(t.ele(d), h).up());
                    } else
                      for (d in e)
                        if (u.call(e, d))
                          if (((l = e[d]), d === r)) {
                            if (
                              ...
                              for (i in l) (g = l[i]), (t = t.att(i, g));
                          } else if (d === o)
                            t =
                              f.options.cdata && s(l) ? t.raw(a(l)) : t.txt(l);
                            ...
                            "object" === (void 0 === l ? "undefined" : n(l))
                              ? (t = c(t.ele(d), l).up())
                              : "string" == typeof l && f.options.cdata && s(l)
                              ? (t = t.ele(d).raw(a(l)).up())
                              : (null == l && (l = ""),
                                (t = t.ele(d, l.toString()).up()));
                    return t;
                  }),
                  (l = t.create(h, this.options.xmldec, this.options.doctype, {
        ...
        (c = r(54)),
          ...
          (e.Parser = (function (r) {
            function o(t) {
              ...
              for (r in ((this.options = {}), (n = i[0.2])))
                f.call(n, r) && ((o = n[r]), (this.options[r] = o));
              ...
              (o.prototype.reset = function () {
                ...
                return (
                  ...
                  (this.saxParser.onerror =
                    ...
                    function (t) {
                      if ((o.saxParser.resume(), !o.saxParser.errThrown))
                        return (o.saxParser.errThrown = !0), o.emit("error", t);
                    })),
                  ...
                  (this.saxParser.onopentag = (function (r) {
                    return function (n) {
                      var o, s, u, c, l;
                      if ((((u = {})[e] = ""), !r.options.ignoreAttrs))
                        for (o in (l = n.attributes))
                          f.call(l, o) &&
                            (t in u || r.options.mergeAttrs || (u[t] = {}),
                            (s = r.options.attrValueProcessors
                              ? a(
                            ...
                            (c = r.options.attrNameProcessors
                              ? a(r.options.attrNameProcessors, o)
                              : o),
                            r.options.mergeAttrs
                              ? r.assignOrPush(u, c, s)
                              : (u[t][c] = s));
                      return (
                        (u["#name"] = r.options.tagNameProcessors
                          ? a(r.options.tagNameProcessors, n.name)
                          : n.name),
                        r.options.xmlns &&
                          (u[r.options.xmlnskey] = {
                            uri: n.uri,
                            local: n.local,
                          }),
                        i.push(u)
                  ...
                  (this.saxParser.onclosetag = (function (t) {
                    return function () {
                      ...
                      if (
                        ...
                        h[e].match(/^\s*$/) && !r
                          ...
                          : (t.options.trim && (h[e] = h[e].trim()),
                            ...
                            (h[e] = t.options.valueProcessors
                              ? a(t.options.valueProcessors, h[e], l)
                              : h[e]),
                        ...
                        s(h) &&
                          (h =
                            "" !== t.options.emptyTag ? t.options.emptyTag : o),
                        null != t.options.validator &&
                          ((m =
                            "/" +
                            (function () {
                              var t, e, r;
                              for (r = [], t = 0, e = i.length; t < e; t++)
                                (c = i[t]), r.push(c["#name"]);
                              return r;
                            })()
                              .concat(l)
                        ...
                        t.options.explicitChildren &&
                          ...
                          "object" === (void 0 === h ? "undefined" : n(h)))
                      )
                        if (t.options.preserveChildrenOrder) {
                          if (g) {
                            for (u in ((g[t.options.childkey] =
                              g[t.options.childkey] || []),
                            (p = {}),
                            h))
                              f.call(h, u) && (p[u] = h[u]);
                      ...
                      if ((o = i[i.length - 1]))
                        return (
                          ...
                          t.options.explicitChildren &&
                            ...
                            ((n = { "#name": "__text__" })[e] = r),
                            t.options.normalize &&
                              (n[e] = n[e].replace(/\s{2,}/g, " ").trim()),
                            o[t.options.childkey].push(n)),
                          o
                        );
                    };
                  })(this)),
            ...
            return (
              null != i
                ? ("function" == typeof i && (o = i),
                  "object" === (void 0 === r ? "undefined" : n(r)) && (s = r))
                : ("function" == typeof r && (o = r), (s = {})),
              new e.Parser(s).parseString(t, o)
            );
          });
      }.call(void 0));
    },
        ...
        !(function (e) {
                ...
                for (; (i = B(t, r++)), (this.c = i), i; )
                  switch (
                    ...
                    case _.TEXT:
                      ...
                      (this.sawRoot && this.closedRoot && !this.strict)
                        ? (g(i) ||
                            ...
                            O(this, "Text data outside of root node."),
                          "&" === i
                    ...
                    case _.PROC_INST_BODY:
                      if (!this.procInstBody && g(i)) continue;
                      "?" === i
                        ? (this.state = _.PROC_INST_ENDING)
                        : (this.procInstBody += i);
                      continue;
                      ...
                      b(f, i)
                        ...
                        : (k(this),
                          ">" === i
                            ...
                            : (g(i) || O(this, "Invalid character in tag name"),
                              (this.state = _.ATTRIB)));
                      continue;
                    ...
                    case _.ATTRIB:
                      ...
                      ">" === i
                        ...
                        : O(this, "Invalid attribute name");
                      continue;
                    case _.ATTRIB_NAME:
                      "=" === i
                        ? (this.state = _.ATTRIB_VALUE)
                        : ">" === i
                        ? (O(this, "Attribute without value"),
                    ...
                    case _.ATTRIB_VALUE:
                      ...
                      m(i)
                        ...
                        : (O(this, "Unquoted attribute value"),
                    ...
                    case _.ATTRIB_VALUE_CLOSED:
                      g(i)
                        ...
                        ? (this.state = _.OPEN_TAG_SLASH)
                        : b(h, i)
                        ? (O(this, "No whitespace between attributes"),
                          (this.attribName = i),
                          (this.attribValue = ""),
                          (this.state = _.ATTRIB_NAME))
                        : O(this, "Invalid attribute name");
                    ...
                    case _.ATTRIB_VALUE_UNQUOTED:
                      ...
                      P(this), ">" === i ? q(this) : (this.state = _.ATTRIB);
                      continue;
                    case _.CLOSE_TAG:
                      if (this.tagName)
                        ">" === i
                          ...
                          ? ((this.script += "</" + this.tagName),
                            (this.tagName = ""),
                            (this.state = _.SCRIPT))
                          : (g(i) || O(this, "Invalid tagname in closing tag"),
                        ...
                        v(h, i)
                          ? this.script
                            ? ((this.script += "</" + i),
                              (this.state = _.SCRIPT))
                            : O(this, "Invalid tagname in closing tag.")
                          : (this.tagName = i);
                      }
                      continue;
                    case _.CLOSE_TAG_SAW_WHITE:
                      ...
                      ">" === i
                        ? I(this)
                        : O(this, "Invalid characters in closing tag");
                      continue;
                    case _.TEXT_ENTITY:
                    ...
                    case _.ATTRIB_VALUE_ENTITY_U:
                      ...
                      ";" === i
                        ? ((this[c] += M(this)),
                          (this.entity = ""),
                          (this.state = u))
                        : b(this.entity.length ? d : p, i)
                        ? (this.entity += i)
                        : (O(this, "Invalid character in entity name"),
                      ...
                      if (a > r)
                        switch (o[i]) {
                          ...
                          case "script":
                            ...
                            break;
                          default:
                            N(t, "Max buffer length exceeded: " + o[i]);
                        }
                      n = Math.max(n, a);
                    }
          ...
          function R(t) {
            (t.textNode = C(t.opt, t.textNode)),
              t.textNode && A(t, "ontext", t.textNode),
              (t.textNode = "");
          }
          function C(t, e) {
            return (
            ...
            String.fromCodePoint ||
              ...
              (E = function () {
                ...
                for (var s = ""; ++i < o; ) {
                  ...
                  if (!isFinite(a) || a < 0 || a > 1114111 || T(a) !== a)
    ...
    function (t, e, r) {
      ...
      (n.podcastFeed = ["author", "subtitle", "summary", "explicit"].map(i)),
        (n.podcastItem = [
          "author",
          "subtitle",
          "summary",
        ...
        (i.copyFromXML = function (t, e, r) {
          r.forEach(function (r) {
            var n = r,
              ...
              s = {};
            Array.isArray(r) &&
              ((n = r[0]), (o = r[1]), r.length > 2 && (s = r[2]));
            var a = s,
              u = a.keepArray,
              c = a.includeSnippet;
            void 0 !== t[n] && (e[o] = u ? t[n] : t[n][0]),
              e[o] && "string" == typeof e[o]._ && (e[o] = e[o]._),
              c &&
                e[o] &&
                "string" == typeof e[o] &&
                (e[o + "Snippet"] = i.getSnippet(e[o]));
          });
        }),
